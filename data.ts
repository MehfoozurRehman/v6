...
export const projects: Project[] = [
  {
    ...
    summary: 'A cloud-based school ERP for small to mid-sized schools in Pakistan with admissions, attendance, exams, family profiles, challans, staff tools and parent communication.',
    businessValue: 'Helps schools replace scattered spreadsheets and manual follow-ups with one reliable daily workflow.',
  ...
  },
  {
    ...
    summary: 'A recording and animation tool that helps create polished clips with customizable templates and a streamlined capture flow.',
    businessValue: 'Reduces the work needed to produce branded motion content and short recorded demos.',
