  ...
  return (
    <section className="mx-auto max-w-340 px-5 py-12 sm:px-8 lg:px-12 lg:py-18 xl:px-16 border-t border-(--border-subtle)">
      <div className="mb-9 max-w-3xl">
        <p className="mb-4 text-[0.72rem] font-black uppercase tracking-[0.16em] text-(--color-accent)">Activity</p>
        <h2 className="font-(family-name:--font-nunito) font-extrabold leading-[0.98] tracking-normal text-[clamp(1.35rem,1.65vw,1.85rem)]">GitHub contributions this year.</h2>
      </div>

      <div suppressHydrationWarning>
        {mounted ? (
          <Suspense fallback={<div className="h-32 bg-(--color-field) rounded-lg animate-pulse" />}>
            <GitHubCalendar
